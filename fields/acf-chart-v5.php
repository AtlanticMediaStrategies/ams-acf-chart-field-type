...
class acf_field_chart extends acf_field {
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-chart'),
			'instructions'	=> __('Customise the input font size','acf-chart'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-chart', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-chart');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-chart', "{$dir}css/input.css" ); 
		wp_enqueue_style('acf-input-chart');
